...
def encode(n: int, charset=CHARSET_DEFAULT):
...
def encodebytes(barray: bytes, charset=CHARSET_DEFAULT):
...
def decode(encoded: str, charset=CHARSET_DEFAULT):
